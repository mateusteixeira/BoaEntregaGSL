...
public class SpringFoxConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                ...
                "1.0.0",
                "Terms of service",
                new Contact("Mateus Felipe Teixeira", "https://www.linkedin.com/in/mateus-felipe-teixeira-7ab5747a/  ---  https://github.com/mateusteixeira", "mateusteixeira_@hotmail.com"),
                "License of API",
                "API license URL",
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .paths(PathSelectors.ant("/enterprise/*"))
                .build()
