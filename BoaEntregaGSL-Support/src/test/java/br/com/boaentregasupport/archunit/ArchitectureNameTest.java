package br.com.boaentregasupport.archunit;
...
public class ArchitectureNameTest {
    ...
    public void setup() {
        importedClasses = new ClassFileImporter()
                ...
                .importPackages("br.com.boaentregasupport");
    }
    ...
    void translator_classes_should_reside_in_package_translator() {
        classes()
                ...
                .should().haveSimpleNameNotEndingWith("Translator").orShould().haveSimpleNameNotEndingWith("TranslatorImpl")
                .check(importedClasses);
    }
